...
const PostPage = async ({ params }: PostPageProps) => {
  ...
  return (
    <main className="flex flex-col min-h-screen">
      {post && (
        <div>
          <section className="block text-zinc-100  w-full relative px-5 z-0">
            <div className="pt-1 max-w-7xl mx-auto px-5 sm:px-10">
              <div className="-mx-6 pt-1">
                <div className="mt-5 sm:mt-10 mb-6 sm:mb-8">
                  <Link href={`/?category=${post.category}`}>
                    <p className="capitalize bg-gradient-to-r from-purple-600 to-red-600 inline-block text-transparent bg-clip-text font-bold mb-3">
                      {post.category}
                    </p>
                  </Link>
                  ...
                  <p className="text-base text-gray-700 dark:text-zinc-100">
                    {post.description}
                  </p>
                </div>
                <div className="-px-6">
            ...
            <div className="absolute w-full bottom-0 bg-white dark:bg-dark h-20 -z-10 -mx-5"></div>
          </section>
            ...
            <div className="sm:-mx-5 mt-5 border-b border-blue-500 pb-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <time
                  ...
                  className="font-mono flex-shrink-0 text-sm text-gray-600 dark:text-zinc-400 pl-6 border-l min-h-[28px] mt-2 dark:border-zinc-800"
                >
