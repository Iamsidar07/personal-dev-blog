const Loading = () => {
  return (
    <main className="flex flex-col lg:flex-row lg:flex-wrap items-center lg:items-stretch gap-1 lg:gap-2 justify-end  min-h-screen p-4 lg:p-6">
      ...
      <section className="w-full flex-1 h-72 lg:h-[75%] flex flex-col gap-2 bg-zinc-100 dark:bg-zinc-800 animate-pulse rounded-2xl">
        <div className="w-full h-12 bg-zinc-100 dark:bg-zinc-800 animate-pulse lg:w-[704px] lg:h-[52px]"></div>
