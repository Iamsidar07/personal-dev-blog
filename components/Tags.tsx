  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        type="button"
        className="inline-flex h-full  justify-between sm:min-w-32 px-4 py-3.5 text-sm font-medium border border-transparent rounded-md hover:bg-teal-500 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-indigo-500 transition-all duration-300 bg-zinc-50 dark:bg-zinc-800/90 ring-1 ring-zinc-900/5 dark:ring-white/10 dark:shadow-lg dark:shadow-zinc-800/90"
        id="options-menu"
      ...
      {isOpen && (
        ...
        >
          <li>
            <button
              type="button"
              className="block text-left w-full px-4 py-2 text-sm hover:bg-zinc-100 dark:hover:bg-zinc-800/90"
              role="option"
          ...
          {options?.map((option) => (
            <li key={option._id}>
              <button
                type="button"
                className="block text-left capitalize w-full px-4 py-2 text-sm hover:bg-zinc-100 dark:hover:bg-zinc-800/90"
                role="option"
